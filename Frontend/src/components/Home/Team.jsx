  ...
  const teamMembers = [
    {
      ...
      bio: "Leads and builds secure systems.",
      image: "👨‍💼",
      social: {
        twitter: "#",
        linkedin: "#",
    ...
    },
    {
      ...
      bio: "Analyzes data and builds UI.",
      image: "👩‍🎨",
      social: {
        twitter: "#",
        linkedin: "#",
      ...
      <div style={styles.container}>
        <div style={styles.header}>
          ...
          <h2 style={styles.title}>
            The <span style={styles.highlight}>Team</span>
          </h2>
        </div>
