...
import { recentFiles, userActivity } from "../Data/SampleData";
...
// Aggregate recent activity counts by user for bar chart
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-400 hover:text-gray-300">
                          {file.size} • {file.date} • {file.sharedBy}
                        </div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-green-400">{file.views || 0}</div>
                      </div>
                      <div>
                        <div className="text-sm font-medium text-gray-300">
                          Last Access
